...
void cardread(int []);//This function will read the values of each card, and display
                //an output in response to said card
void player1(float, float, float, float, float);//This is the card that will read
                    //player 1 cards, and output it back into main in order to 
                    //avoid clogging up my main
...
//Variables in the option 1-------------------------------------------------
    ...
    int plycnt[rulep];//The parallel array in order for the rule in the nested loop
                    //to show the player count in the card recieving
...
//welcome screen of the 2nd case           
 ...
 do 
 {
    ...
    //This part of the function will check the cards and output the results 
    //in the first player option
    player1(card, card1, card2, card3, card4);
...
//This function will evaluate how many players are going to be participating
//and return a boolian in order to determine if the game will have one or 2
//players 
...
//This part of the program reads the card for the 2 player game, and outputs
//the results
...
//This function passes of the 5 floats from the project 1 checklist
//For the first player option, this will check the cards and output the option
void player1 (float card, float card1, float card2, float card3, float card4){
      cout << fixed << showpoint << setprecision(1);
